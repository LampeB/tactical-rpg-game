...
const PLAYER_SPEED := 2.0           ## World units per second
const PLAYER_SPRINT_MULTIPLIER := 5.0  ## Speed multiplier when holding sprint
...
const ELEMENT_COLORS := {
	...
	Enums.Element.AIR: Color(1.0, 1.0, 1.0),
